//<!--
//Google location API: "https://maps.googleapis.com/maps/api/geocode/json?address=chicago&key=AIzaSyCWVdkdNrFdMvFoJ9hWE1G9iCiOxAUoAx8"
...
const Container = React.createClass({
	...
	getCoordinates: function(location){
		var coordinate="";
		$.ajax({
			url: 'https://maps.googleapis.com/maps/api/geocode/json?address='+this.state.location+'&key=AIzaSyCWVdkdNrFdMvFoJ9hWE1G9iCiOxAUoAx8',
			method: 'get',
